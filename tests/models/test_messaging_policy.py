...
class TestSlackMessagingPolicy(ModelTestBase):
    ...
    def test_str(self) -> None:
        ...
        instance = self.factory_cls(code="OP-641-XA01", enabled=True, recipients=recipients)
        ...
        instance = self.factory_cls(code="REPORT-1178-CR9217", enabled=False, recipients=recipients)
