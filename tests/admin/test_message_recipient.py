...
from django_slack_bot.admin.message_recipient import _get_channels
...
class TestSlackMessageRecipientAdmin(ModelAdminTestBase):
    ...
    def test_update_channel_names(self, admin_client: Client) -> None:
        ...
        # Perform action
        with mock.patch("django_slack_bot.admin.message_recipient._get_channels", return_value=_channels):
